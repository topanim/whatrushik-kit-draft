...
val SHUIIcons.FolderSearch2: ImageVector
    get() {
        if (_FolderSearch2 != null) {
            return _FolderSearch2!!
        }
        _FolderSearch2 = ImageVector.Builder(
            name = "FolderSearch2",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            ...
            path(
                ...
                moveTo(11.5f, 15f)
                curveTo(12.881f, 15f, 14f, 13.881f, 14f, 12.5f)
                curveTo(14f, 11.119f, 12.881f, 10f, 11.5f, 10f)
                curveTo(10.119f, 10f, 9f, 11.119f, 9f, 12.5f)
                curveTo(9f, 13.881f, 10.119f, 15f, 11.5f, 15f)
                close()
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
