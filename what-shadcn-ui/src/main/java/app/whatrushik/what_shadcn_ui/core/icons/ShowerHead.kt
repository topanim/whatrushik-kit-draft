...
val SHUIIcons.ShowerHead: ImageVector
    get() {
        if (_ShowerHead != null) {
            return _ShowerHead!!
        }
        _ShowerHead = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(13.5f, 6.5f)
                curveTo(12.568f, 5.587f, 11.314f, 5.079f, 10.01f, 5.086f)
                curveTo(8.706f, 5.092f, 7.457f, 5.613f, 6.535f, 6.535f)
                curveTo(5.613f, 7.457f, 5.092f, 8.706f, 5.085f, 10.01f)
                curveTo(5.079f, 11.315f, 5.587f, 12.569f, 6.5f, 13.5f)
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 2f,
