...
val SHUIIcons.Film: ImageVector
    get() {
        if (_Film != null) {
            return _Film!!
        }
        _Film = ImageVector.Builder(
            ...
            path(
                ...
                curveTo(2.976f, 2f, 2f, 2.976f, 2f, 4.18f)
                verticalLineTo(19.82f)
                curveTo(2f, 21.024f, 2.976f, 22f, 4.18f, 22f)
                horizontalLineTo(19.82f)
                curveTo(21.024f, 22f, 22f, 21.024f, 22f, 19.82f)
                verticalLineTo(4.18f)
                curveTo(22f, 2.976f, 21.024f, 2f, 19.82f, 2f)
                close()
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
