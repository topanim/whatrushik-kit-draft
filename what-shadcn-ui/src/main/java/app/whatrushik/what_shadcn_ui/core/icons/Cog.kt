    ...
    get() {
        ...
        _Cog = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(12f, 14f)
                curveTo(12.53f, 14f, 13.039f, 13.789f, 13.414f, 13.414f)
                curveTo(13.789f, 13.039f, 14f, 12.53f, 14f, 12f)
                curveTo(14f, 11.47f, 13.789f, 10.961f, 13.414f, 10.586f)
                curveTo(13.039f, 10.211f, 12.53f, 10f, 12f, 10f)
                curveTo(11.47f, 10f, 10.961f, 10.211f, 10.586f, 10.586f)
                curveTo(10.211f, 10.961f, 10f, 11.47f, 10f, 12f)
                curveTo(10f, 12.53f, 10.211f, 13.039f, 10.586f, 13.414f)
                curveTo(10.961f, 13.789f, 11.47f, 14f, 12f, 14f)
                close()
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
