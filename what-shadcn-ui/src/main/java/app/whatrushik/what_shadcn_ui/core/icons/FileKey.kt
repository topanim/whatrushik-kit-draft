...
val SHUIIcons.FileKey: ImageVector
    get() {
        if (_FileKey != null) {
            return _FileKey!!
        }
        _FileKey = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(10f, 18f)
                curveTo(11.105f, 18f, 12f, 17.105f, 12f, 16f)
                curveTo(12f, 14.895f, 11.105f, 14f, 10f, 14f)
                curveTo(8.895f, 14f, 8f, 14.895f, 8f, 16f)
                curveTo(8f, 17.105f, 8.895f, 18f, 10f, 18f)
                close()
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
