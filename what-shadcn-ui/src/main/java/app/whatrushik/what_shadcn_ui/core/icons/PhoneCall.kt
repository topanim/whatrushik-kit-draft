...
val SHUIIcons.PhoneCall: ImageVector
    get() {
        if (_PhoneCall != null) {
            return _PhoneCall!!
        }
        _PhoneCall = ImageVector.Builder(
            ...
            path(
                ...
                moveTo(14.05f, 2f)
                curveTo(16.088f, 2.215f, 17.992f, 3.119f, 19.447f, 4.563f)
                curveTo(20.902f, 6.006f, 21.82f, 7.903f, 22.05f, 9.94f)
            }
            path(
                stroke = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 2f,
                ...
                moveTo(14.05f, 6f)
                curveTo(15.034f, 6.194f, 15.936f, 6.679f, 16.64f, 7.392f)
                curveTo(17.345f, 8.106f, 17.819f, 9.014f, 18f, 10f)
            }
        }.build()
